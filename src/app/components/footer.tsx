              ...
              <div className="grid sm:grid-cols-2 gap-8 xl:justify-items-center sm:gap-6 xl:grid-cols-3">
                <div>
                  ...
                  <ul className="text-gray-600">
                    <li className="mb-4">
                      <div>Monday: 08:00–21:00</div>
                    </li>
                    <li className="mb-4">
                      <div>Tuesday: 08:00–21:00</div>
                    </li>
                    <li className="mb-4">
                      <div>Wednesday: 08:00–21:00</div>
                    </li>
                    <li className="mb-4">
                      <div>Thursday: 08:00–21:00</div>
                    </li>
                    <li className="mb-4">
                      <div>Friday: 08:00–22:00</div>
                    </li>
                    <li className="mb-4">
                      <div>Saturday: 09:00–23:00</div>
                    </li>
                    <li className="mb-4">
                      <div>Sunday: 09:30–22:00</div>
                    </li>
                    <li className="mb-4">
